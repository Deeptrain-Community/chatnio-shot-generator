      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <div
              className={`flex flex-row items-center text-primary space-x-4`}
            >
              <svg
                role="img"
                viewBox="0 0 24 24"
            ...
            <div
              className={`flex flex-row items-center space-x-4 mt-4 text-sm`}
            >
              <div className={`flex flex-row items-center text-green-500`}>
                <Check className={`w-3.5 h-3.5 mr-1`} />C Side
              </div>
              <div className={`flex flex-row items-center text-green-500`}>
                <Check className={`w-3.5 h-3.5 mr-1`} />B Side
              </div>
            </div>
            <LLMIcons />
          </div>
          <div className={`h-full flex-grow flex ml-6 p-6 z-10`}>
            <div className={`h-full grid grid-cols-2 gap-2.5`}>
              ...
              />
              <img
                src={`/screenshot/admin.png`}
                alt={``}
                className={`border p-0.5 rounded-md`}
              />
              <img
                src={`/screenshot/mask-editor.png`}
                alt={``}
                className={`border p-0.5 rounded-md`}
              />
            </div>
